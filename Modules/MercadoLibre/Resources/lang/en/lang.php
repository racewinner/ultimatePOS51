...
return [
    ...
    'integrate_with_mercadolibre' => "Integrate with MercadoLibre",
    'api_settings' => 'API Settings',
    'mercadolibre_app_url' => 'MercadoLibre App URL',
    'mercadolibre_consumer_key' => 'MercadoLibre Consumer Key',
    'mercadolibre_consumer_secret' => 'MercadoLibre Consumer Secret',
    'sync_product_categories' => 'Sync Product Categories',
    'sync' => 'Sync',
    'synced_successfully' => 'Synced successfully',
    'location_dropdown_help' => 'Location which will be used for MercadoLibre',
    'sync_all' => 'Sync all',
    'sync_only_new' => 'Sync only new',
    'sync_products' => 'Sync Products',
    'sync_all_help' => '<ul><li>Synchronizes all your products with the MercadoLibre App.</li><li><b><i>*(Time consuming process)</i></b></li><li>Please, Do not refresh or leave the page while synchronizing</li></ul>',
    'sync_new_help' => '<ul><li>Synchronizes only newly created products with the MercadoLibre App.</li><li><b><i>*(Less time consuming process)</i></b></li><li>Please, Do not refresh or leave the page while synchronizing</li></ul>',
    ...
    'equivalent_mercadolibre_tax_rate' => 'Equivalent MercadoLibre Tax Rate',
    'default_tax_class' => 'Default Tax Class',
    'default_tax_class_help' => 'MercadoLibre Tax Class which will be set as default while synchronizing products. (Default: standard)',
    ...
    'product_fields_to_be_synced_for_create' => 'Product fields to be synced with mercadolibre while creating products',
    'product_fields_to_be_synced_for_update' => 'Product fields to be synced with mercadolibre while updating products',
    'price' => 'Price',
    'sync_log' => 'Sync Log',
    'operation' => 'Operation',
    'sync_type' => 'Sync Type',
    ...
    'ins_2' => 'Timezone of POS should be same as timezone of the MercadoLibre App',
    'unable_to_connect' => 'Unable to connect with MercadoLibre, Check API settings',
    'api_settings_help_text' => 'Get MercadoLibre API details from, <code>MercadoLibre -> Settings -> Advance -> REST API </code>. Enter description, select User & Provide <code>Read/Write</code> Permission',
    'syncing' => 'Syncing',
    ...
    'mercadolibre_module' => 'MercadoLibre Module',
    'version_info' => 'MercadoLibre module version - <code>:version</code>',
    ...
    'access_mercadolibre_api_settings' => 'Access MercadoLibre API settings',
    'orders_sync_notification' => 'All mercadolibre orders have been synced successfully',
    ...
    'mercadolibre_disable_sync' => 'Disable MercadoLibre Sync',
    'mercadolibre_disable_sync_help' => 'If checked this product will not be synced with mercadolibre',
    ...
    'mercadolibre_order_status' => 'MercadoLibre order status',

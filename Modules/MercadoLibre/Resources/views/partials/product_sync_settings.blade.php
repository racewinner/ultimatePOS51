    ...
    <div class="row">
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('default_tax_class',  __('mercadolibre::lang.default_tax_class') . ':') !!} @show_tooltip(__('mercadolibre::lang.default_tax_class_help'))
                {!! Form::text('default_tax_class',$default_settings['default_tax_class'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('product_tax_type',  __('mercadolibre::lang.sync_product_price') . ':') !!}
                {!! Form::select('product_tax_type', ['inc' => __('mercadolibre::lang.inc_tax'), 'exc' => __('mercadolibre::lang.exc_tax') ], $default_settings['product_tax_type'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('default_selling_price_group',  __('mercadolibre::lang.default_selling_price_group') . ':') !!}
        ...
        <div class="col-xs-12">
            <div class="form-group">
                <label for="#">@lang('mercadolibre::lang.product_fields_to_be_synced_for_create'):</label><br>
                <label class="checkbox-inline">
                  {!! Form::checkbox('product_fields_for_create[]', 'name', true, ['class' => 'input-icheck', 'disabled'] ); !!}
                  @lang('product.product_name')
                </label>
                <label class="checkbox-inline">
                    {!! Form::checkbox('product_fields_for_create[]', 'image', in_array('image', $default_settings['product_fields_for_create']), ['class' => 'input-icheck', 'disabled'] ); !!} @lang('mercadolibre::lang.images')
                </label>
                <label class="checkbox-inline">
                  {!! Form::checkbox('product_fields_for_create[]', 'price', true, ['class' => 'input-icheck', 'disabled'] ); !!}
                  @lang('mercadolibre::lang.price')
                </label>
                <label class="checkbox-inline">
        ...
        <div class="col-xs-4 @if(in_array('quantity', $default_settings['product_fields_for_create'])) hide @endif create_stock_settings">
            <div class="form-group">
                ...
                {!! Form::select('manage_stock_for_create', ['true' => 'true', 'false' => 'false', 'none' => __('mercadolibre::lang.dont_update') ], isset($default_settings['manage_stock_for_create']) ? $default_settings['manage_stock_for_create'] : 'none', ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-4 @if(in_array('quantity', $default_settings['product_fields_for_create'])) hide @endif create_stock_settings">
            <div class="form-group">
                {!! Form::label('in_stock_for_create',  __('mercadolibre::lang.in_stock') . ':') !!}
                {!! Form::select('in_stock_for_create', ['true' => 'true', 'false' => 'false', 'none' => __('mercadolibre::lang.dont_update') ], isset($default_settings['in_stock_for_create']) ? $default_settings['in_stock_for_create'] : 'none', ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-12">
            <hr>
        ...
        <div class="col-xs-12">
            <br/>
            <div class="form-group">
                <label for="#">@lang('mercadolibre::lang.product_fields_to_be_synced_for_update'):</label><br>
                <label class="checkbox-inline">
                    {!! Form::checkbox('product_fields_for_update[]', 'name', in_array('name', $default_settings['product_fields_for_update']), ['class' => 'input-icheck'] ); !!}
                  @lang('product.product_name')
                </label>
                <label class="checkbox-inline">
                    {!! Form::checkbox('product_fields_for_update[]', 'image', in_array('image', $default_settings['product_fields_for_update']), ['class' => 'input-icheck'] ); !!} @lang('mercadolibre::lang.images')
                </label>
                <label class="checkbox-inline">
        ...
        <div class="col-xs-4 @if(in_array('quantity', $default_settings['product_fields_for_update'])) hide @endif update_stock_settings">
            <div class="form-group">
                ...
                {!! Form::select('manage_stock_for_update', ['true' => 'true', 'false' => 'false', 'none' => __('mercadolibre::lang.dont_update') ], isset($default_settings['manage_stock_for_update']) ? $default_settings['manage_stock_for_update'] : 'none', ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-4 @if(in_array('quantity', $default_settings['product_fields_for_update'])) hide @endif update_stock_settings">
            <div class="form-group">
                {!! Form::label('in_stock_for_update',  __('mercadolibre::lang.in_stock') . ':') !!}
                {!! Form::select('in_stock_for_update', ['true' => 'true', 'false' => 'false', 'none' => __('mercadolibre::lang.dont_update') ], isset($default_settings['in_stock_for_update']) ? $default_settings['in_stock_for_update'] : 'none', ['class' => 'form-control']); !!}
            </div>
        </div>
    </div>
</div>
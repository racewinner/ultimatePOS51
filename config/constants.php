...
return [
    ...
    */
    ...
    'cfe_types' => [
        '101' => 'eTicket',
        '102' => 'Nota de Credito eTicket',
        '103' => 'Nota de Debito eTicket',
        '111' => 'e-Factura',
        '112' => 'Nota de Credito eFactura',
        '113' => 'Nota de Debito eFactura',
        '181' => 'Remito',
        '281' => 'Remito',
    ],
    'cfe_status' => [
        ...
        'CREATED_WITHOUT_CAE_NRO' => 'CREATED_WITHOUT_CAE_NRO',
        'SENT' => 'SENT',
        'PROCESSED_ACCEPTED' => 'PROCESSED_ACCEPTED',
        'REPORTED_DAILY_REPORT' => 'REPORTED_DAILY_REPORT',
        'HAS_NO_RECEIVER' => 'HAS_NO_RECEIVER',
        'CFES_STATUS_QUERY_SENT_TO_RECEIVER' => 'CFES_STATUS_QUERY_SENT_TO_RECEIVER',
    ]
];
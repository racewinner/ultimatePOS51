...
use App\Http\Controllers\PymoController;
...
use App\Http\Controllers\NationExchgRateHistoryController;
use App\Http\Controllers\BcuController;
...
Route::middleware(['setData'])->group(function () {
    ...
    Route::post('/business/register/check-pin', [BusinessController::class, 'postCheckPin'])->name('business.postCheckPin');

    Route::get('/invoice/{token}', [SellPosController::class, 'showInvoice'])
        ->name('show_invoice');
    Route::get('/invoice/transaction/{id}', [SellPosController::class, 'showTransactionInvoice'])
        ->name('show_transaction_invoice');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/business/nerh/{startDate}/{endDate}', [BusinessController::class, 'getNationExchgRateHistory'])->name('nerh');
    ...
    Route::get('/contacts/download-excel', [ContactController::class, 'downloadExcel']);
    ...
    Route::get('/sells/ondue/{contact_id}', [SellController::class, 'getSellsOnDue']);
    Route::get('/sells/copy-quotation/{id}', [SellPosController::class, 'copyQuotation']);

    Route::get('/remitos/create', [RemitoController::class, 'create']);
    Route::get('/remitos/{id}/show_internal_invoice', [RemitoController::class, 'showInternalInvoice']);
    ...
    Route::get('/purchases/ondue/{contact_id}', [PurchaseController::class, 'getPurchasesOnDue']);
    ...
    Route::resource('notificationsusers', NotificationUserController::class);
    Route::post('/notificationsusers/update', [NotificationUserController::class, 'update']);
    Route::get('/notifications/get_users', [NotificationController::class, 'getUsers']);
    ...
    Route::get('/reports/purchase-invoice-payment-report', [ReportController::class, 'purchaseInvoicePaymentReport']);
    Route::get('/reports/sell-payment-report', [ReportController::class, 'sellPaymentReport']);
    Route::get('/reports/sell-invoice-payment-report', [ReportController::class, 'sellInvoicePaymentReport']);
    ...
    Route::get('/payments/add_multi_payment/{contact_id}', [TransactionPaymentController::class, 'createMultiPayment']);
    Route::post('/payments/store_multi_payment', [TransactionPaymentController::class, 'storeMultiPayment']);
    Route::post('/payments/update_multi_payment', [TransactionPaymentController::class, 'updateMultiPayment']);
    ...
    Route::get('/sell-return/print/{id}/{pdf_format?}', [SellReturnController::class, 'printInvoice']);
    ...
    Route::post('pymo/login', [PymoController::class, 'login']);
    Route::post('pymo/save', [PymoController::class, 'save']);
    Route::post('pymo/sendInvoice', [PymoController::class, 'sendInvoice']);
    Route::post('pymo/sendRemitoInvoice', [PymoController::class, 'sendRemitoInvoice']);
    Route::post('pymo/sendReturnInvoice', [PymoController::class, 'sendReturnInvoice']);
    Route::post('pymo/sendReceiptInvoice', [PymoController::class, 'sendReceiptInvoice']);
    Route::post('pymo/getInvoice', [PymoController::class, 'getInvoice']);
    Route::get('pymo/sentCfes', [PymoController::class, 'sentCfes']);
    Route::get('pymo/purchaseCfes', [PymoController::class, 'purchaseCfes']);
    Route::get('pymo/generateInvoice', [PymoController::class, 'getGenerateInvoice']);
    Route::post('pymo/generateInvoice',  [PymoController::class, 'postGenerateInvoice']);
});
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/sells/pymo-invoice-url/{id}', [SellPosController::class, 'showPymoInvoiceUrl']);
    Route::get('/show-notification/{id}', [HomeController::class, 'showNotification']);
    
});

Route::get('/bcu/current_rate', [BcuController::class, 'getCurrentRate'])->name('bcu.getCurrentRate');
Route::get('/bcu/crontask', [BcuController::class, 'cronTask'])->name('bcu.cronTask');
...
Route::get('/test/clear_cache', [TestController::class, 'clearCache']);
Route::get('/test/clear_config', [TestController::class, 'clearConfig']);
Route::get('/test/clear_view', [TestController::class, 'clearView']);
Route::get('/test/clear_all', [TestController::class, 'clearAll']);
Route::get('/test/phpinfo', [TestController::class, 'showPhpInfo']);

    ...
    var buttons = [
        ...
        },
        {
            ...
            customize: function (win) {
                ...
                let elH1 = win.document.querySelector("h1");
                ...
                let printDateDiv = win.document.createElement("div");
                $(printDateDiv).text(nowStr)
                newDiv.appendChild(printDateDiv);

                // To add user
                let username = $("input#__logon_user").val();
                if(username) {
                    let userDiv = win.document.createElement("div");
                    $(userDiv).text(username);
                    newDiv.appendChild(userDiv);
                }

                elH1.insertAdjacentElement('afterend', newDiv);

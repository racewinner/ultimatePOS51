$(document).ready(function() {
    ...
    $(document).on('change', 'select[name="currency_id"]', function(e){
        ...
        const cur_exchg_rate = $("input[name='exchange_rate']").val();
        const r = cur_currency_id == currencies[0].id ? cur_exchg_rate : 1/cur_exchg_rate;
    
        $("table#purchase_return_product_table > tbody tr").toArray().forEach(tr => {
...
function purchase_return_product_row(variation_id) {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            var this_row = $('table#purchase_return_product_table tbody').find('tr').last();
            ...
            if( prod_currency_id && prod_currency_id != '0' && cur_currency_id != prod_currency_id) {
                const cur_exchg_rate = $("input[name='exchange_rate']").val();
                const r = prod_currency_id == currencies[0].id ? 1 / cur_exchg_rate : cur_exchg_rate;
...
function update_table_total() {
    ...
    $('span#total_return').text(__currency_trans_from_en(final_total, true, true));
}

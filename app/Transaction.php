...
class Transaction extends Model
{
    ...
    public function remito_lines()
    {
        return $this->hasMany(\App\RemitoLine::class);
    }
    ...
    public function authorizor()
    {
        return $this->belongsTo(\App\User::class, 'authorized_by');
    }
    ...
    public function getDocument2PathAttribute()
    {
        $path = ! empty($this->document2) ? asset('/uploads/documents/'.$this->document2) : null;
        return $path;
    }
    ...
    {
        return empty($this->pymo_invoice);
    }
}

...
class StockTransferController extends Controller
{
            ...
            return Datatables::of($stock_transfers)
                ...
                ->editColumn(
                    'final_total', function($row) use ($business) {
                        ...
                        return '<span>'
                                . \App\Utils\Util::format_currency($final_total, $row->currency)
                                . '</span>';
                    }
                )
                ->editColumn(
                    'shipping_charges', function($row) use($currencies) {
                        $shipping_charge = $row->shipping_charges;
                        return '<span>'
                                . \App\Utils\Util::format_currency($shipping_charge, $row->currency)
                                . '</span>';
                    }
                )
    ...
    public function create()
    {
        ...
        return view('stock_transfer.create')
                ->with(compact('business_locations', 'business', 'currencies', 'statuses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input_data = $request->only([  'location_id', 'ref_no', 'transaction_date', 'additional_notes', 
                                            'shipping_charges', 'final_total', 'currency_id', 'nation_exchg_rate']);
    ...
    public function edit($id)
    {
        ...
        return view('stock_transfer.edit')
                ->with(compact('sell_transfer', 'currencies', 'purchase_transfer', 'business_locations', 'statuses', 'products'));
    }

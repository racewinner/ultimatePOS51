...
class ImportSalesController extends Controller
{
    ...
    public function preview(Request $request)
    {
        ...
        if ($request->hasFile('sales')) {
            ...
            return view('import_sales.preview')->with(compact('parsed_array', 'business', 'currencies', 'import_fields', 'file_name', 'business_locations', 'match_array'));
        }
    }
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            $nation_exchg_rate = $request->input('nation_exchg_rate');
            ...
            $this->__importSales($formatted_sales_data, $business_id, $location_id, $currency_id, $nation_exchg_rate);
    ...
    private function __importSales($formated_data, $business_id, $location_id, $currency_id, $nation_exchg_rate)
    {
        $business = Business::find($business_id);
        ...
        foreach ($formated_data as $data) {
            ...
            if($currency_id == $business->currency_id) {
                $exchange_rate = 1;
            } else {
                $exchange_rate = ($currency_id == $business->nation_currency_id) ? 
                                                    1 / $nation_exchg_rate : 
                                                    $nation_exchg_rate;
            }

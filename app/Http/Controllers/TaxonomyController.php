...
class TaxonomyController extends Controller
{
     ...
     * @return void
     */
    public function __construct(ModuleUtil $moduleUtil, MercadoLibreUtil $mercadolibreUtil)
    {
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $category = Category::where('business_id', $business_id)
                            ...
                            ->select(['name', 'short_code', 'mercadolibre_category_id', 'description', 'id', 'parent_id']);
    ...
    public function create()
    {
        ...
        try {
            $mercadolibre_connected = $this->mercadolibreUtil->validateToken();
        } catch(\Exception $e) {
            $mercadolibre_auth_url = $this->mercadolibreUtil->getAuthUrl();
            $mercadolibre_connected = false;
        }

        return view('taxonomy.create')->with(compact('parent_categories', 'module_category_data', 'category_type', 
            'mercadolibre_connected', 'mercadolibre_auth_url'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only(['name', 'short_code', 'category_type', 'description', 'mercadolibre_category_id']);
    ...
    public function update(Request $request, $id)
    {
        if (request()->ajax()) {
            try {
                ...
                if(!empty(request()->input('mercadolibre_category_id'))) {
                    $category->mercadolibre_category_id = request()->input('mercadolibre_category_id');
                }

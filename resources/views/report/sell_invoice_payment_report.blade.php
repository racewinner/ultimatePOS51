@extends('layouts.app')
@section('title', __('lang_v1.sell_invoice_payment_report'))

@section('content')

    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>{{ __('lang_v1.sell_invoice_payment_report')}}</h1>
    </section>
    ...
    <section class="content no-print">
        <div class="row">
            <div class="col-md-12">
                ...
                {!! Form::open(['url' => '#', 'method' => 'get', 'id' => 'sell_invoice_payment_report_form']) !!}
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('sipr_date_filter', __('report.date_range') . ':') !!}
                        {!! Form::text('date_range', null, ['placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control', 'id' => 'sipr_date_filter', 'readonly']) !!}
                    </div>
                </div>
                {!! Form::close() !!}
                @endcomponent
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="sell_invoice_payment_report_table">
                        <thead>
                            <tr>

...
<table class="table table-bordered table-striped" id="stock_report_table">
    <thead>
        <tr>
            ...
            <th>
                @lang('lang_v1.total_stock_price') <br>
                <small>(@lang('lang_v1.by_sale_price')_{{$business->currency->symbol}})</small>
            </th>
            @if(!empty($business->secondCurrency))
            <th class="stock_price_currency2">
                @lang('lang_v1.total_stock_price') <br>
                <small>(@lang('lang_v1.by_sale_price')_{{$business->secondCurrency->symbol}})</small>
            </th>
            @endif
    ...
    <tfoot>
        <tr class="bg-gray font-17 text-center footer-total">
            ...
            @if(!empty($business->secondCurrency))
            <td class="footer_stock_value_by_sale_price_currency2"></td>
            @endif

                    ...
                    <tbody>
                        ...
                        @foreach($expenses as $expense)
                            <tr>
                                ...
                                <td><span>
                                        {{ \App\Utils\Util::format_currency($expense['total_expense'], $business->currency) }}
                                        {{ $business->second_currency_id > 0 ? ' / ' . \App\Utils\Util::format_currency($expense['total_expense'], $business->secondCurrency) : '' }}
                                    </span></td>
                            </tr>
                            @php

    ...
    $(document).ready( function() {
        ...
        profit_by_products_table = $('#profit_by_products_table').DataTable({
                ...
                footerCallback: function ( row, data, start, end, display ) {
                    var total_profit = 0;
                    var total_profit_currency2 = 0;
                    for (var r in data){
                        total_profit += $(data[r].gross_profit).data('orig-value') ? 
                                        parseFloat($(data[r].gross_profit).data('orig-value')) : 0;
                        total_profit_currency2 += $(data[r].gross_profit).data('orig-value-currency2') ? 
                                        parseFloat($(data[r].gross_profit).data('orig-value-currency2')) : 0;
                    }

                    let html = __currency_trans_from(total_profit, true, currencies[0]);
                    if(currencies.length > 1) {
                        html += ' / ' + __currency_trans_from(total_profit_currency2, true, currencies[1]);
                    }
                    $('#profit_by_products_table .footer_total').html(html);
                }
            });
                ...
                if(typeof profit_by_categories_datatable == 'undefined') {
                    profit_by_categories_datatable = $('#profit_by_categories_table').DataTable({
                        ...
                        footerCallback: function ( row, data, start, end, display ) {
                            ...
                            $('#profit_by_categories_table .footer_total').html(html);
                        },
                    });
                } else {
                ...
                if(typeof profit_by_brands_datatable == 'undefined') {
                    profit_by_brands_datatable = $('#profit_by_brands_table').DataTable({
                        ...
                        footerCallback: function ( row, data, start, end, display ) {
                            ...
                            $('#profit_by_brands_table .footer_total').html(html);
                        },
                    });
                } else {
                ...
                if(typeof profit_by_locations_datatable == 'undefined') {
                    profit_by_locations_datatable = $('#profit_by_locations_table').DataTable({
                        ...
                        footerCallback: function ( row, data, start, end, display ) {
                            ...
                            $('#profit_by_locations_table .footer_total').html(html);
                        },
                    });
                } else {
                ...
                if(typeof profit_by_invoice_datatable == 'undefined') {
                    profit_by_invoice_datatable = $('#profit_by_invoice_table').DataTable({
                        ...
                        footerCallback: function ( row, data, start, end, display ) {
                            ...
                            $('#profit_by_invoice_table .footer_total').html(html);
                        }
                    });
                } else {
                ...
                if(typeof profit_by_date_datatable == 'undefined') {
                    profit_by_date_datatable = $('#profit_by_date_table').DataTable({
                        ...
                        footerCallback: function ( row, data, start, end, display ) {
                            ...
                            $('#profit_by_date_table .footer_total').html(html);
                        },
                    });
                } else {
                ...
                if(typeof profit_by_customers_table == 'undefined') {
                    profit_by_customers_table = $('#profit_by_customer_table').DataTable({
                        ...
                        footerCallback: function ( row, data, start, end, display ) {
                            ...
                            $('#profit_by_customer_table .footer_total').html(html);
                        },
                    });
                } else {
                ...
                $.ajax({
                        ...
                        success: function(result) {
                           $('#profit_by_day').html(result); 
                            ...
                            var total_profit_currency2 = sum_table_col($('#profit_by_day_table'), 'gross-profit', 'orig-value-currency2');
                            $('#profit_by_day_table .footer_total').html(
                                __currency_trans_from(total_profit, true, currencies[0]) + 
                                (currencies.length > 1 ? ' / ' + __currency_trans_from(total_profit_currency2, true, currencies[1]) : '')
                            );

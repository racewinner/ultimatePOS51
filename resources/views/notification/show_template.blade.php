    ...
    <div class="modal-body">
      ...
      <div class="box-group" id="accordion">
        ...
        @endif
              <div class="form-group @if($notification_template['template_for'] == 'send_ledger') hide @endif">
                <label>
                  {!! Form::checkbox('notification_type[]', 'email', true, ['class' => 'input-icheck notification_type']) !!}
                  @lang('lang_v1.send_email')
                </label>
              </div>
              <div id="email_div">
      ...
      <div class="panel box box-solid">
        ...
        <div class="box-body">
          <div class="form-group @if($notification_template['template_for'] == 'send_ledger') hide @endif">
          <label>
            {!! Form::checkbox('notification_type[]', 'sms', false, ['class' => 'input-icheck notification_type']) !!}
            @lang('lang_v1.send_sms')
          </label>
          <label>
            {!! Form::checkbox('notification_type[]', 'whatsapp', false, ['class' => 'input-icheck notification_type']) !!}

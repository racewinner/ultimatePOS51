...
@section('content')
<input type="hidden" id="p_code" value="{{$currencies[0]->code}}">
<input type="hidden" id="p_symbol" value="{{$currencies[0]->symbol}}">
<input type="hidden" id="p_thousand" value="{{$currencies[0]->thousand_separator}}">
<input type="hidden" id="p_decimal" value="{{$currencies[0]->decimal_separator}}">
...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::number('nation_exchg_rate', $business_details->nation_exchg_rate, ['class' => 'form-control','required', 'placeholder' => __('lang_v1.currency_exchange_rate')]) !!}
						</div>
					</div>
				</div>
	...
	<div class="row d-flex justify-content-center align-items-center">
		...
		<div class="electronic_bill_tab">
			<div class="checkbox">
				<label>
					<input class="input-icheck" name="pymo_sendinvoice" type="checkbox" v-model="active">
					@lang( 'lang_v1.generate_invoice' )
				</label>
			</div>
		</div>
		<button type="button" id="submit-sell" class="btn btn-primary btn-big ms-4">@lang('messages.save')</button>
		<button type="button" id="save-and-print" class="btn btn-success btn-big ms-4">@lang('lang_v1.save_and_print')</button>
	</div>

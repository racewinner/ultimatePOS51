...
@foreach($variations as $variation)
	<tr>
		...
		<td class="text-center">
			...
			<input type="hidden" class="item_level_purchase_price"
				value="{{$variation->default_purchase_price * $quantity * $multiplier}}">
		</td>
		<td class="text-center">
			<span>
				<i class="fa fa-times remove_combo_product_entry_row text-danger" title="Remove"

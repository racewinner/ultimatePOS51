                    ...
                    <td>
                        ...
                        <div class="col-sm-6 mt-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name='currency_id' class='form-control select2' disabled style="width:100%;">
                                    @foreach ($currencies as $currency)
                                        <option value={{ $currency->id }} 
                                            {{ $variation->currency_id == $currency->id ? 'selected' : '' }}
                        ...
                        <div class="col-sm-6 mt-4">
                            <div class="form-group">
                                ...
                                {!! Form::number('nation_exchg_rate', $variation->nation_exchg_rate, ['class' => 'form-control', 'placeholder' => __('lang_v1.currency_exchange_rate'), 'readonly'=>true ]) !!}
                                </div>
                            </div>
                        </div>
                    </td>

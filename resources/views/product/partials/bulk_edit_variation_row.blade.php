...
<td>
	...
	<div class="input-group">
		...
		{!! Form::text('products[' . $product->id . '][variations][' . $variation->id . '][dpp_inc_tax]', @num_format($variation->dpp_inc_tax), ['placeholder' => __('product.inc_of_tax'), 'class' => 'form-control input-sm input_number pp_inc_tax']) !!}
</td>
</div>
<td>
	{!! Form::text('products[' . $product->id . '][variations][' . $variation->id . '][profit_percent]', @num_format($variation->profit_percent), ['class' => 'form-control input-sm input_number profit_percent3']) !!}
</td>
<td>
	<div class="input-group">
		<span class="input-group-addon"><small>@lang('product.exc_of_tax')</small></span>

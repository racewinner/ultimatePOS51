...
<div class="row">
    ...
    @component('components.filters', ['title' => __('report.filters')])
        ...
        <div class="col-md-3" id="location_filter">
            <div class="form-group">
                {!! Form::label('not_for_selling',  __('lang_v1.not_for_selling') . ':') !!}
                {!! Form::select(
                    'not_for_selling', 
                    ['not_for_selling' => __('lang_v1.not_for_selling'), 'only_for_selling' => __('lang_v1.only_for_selling')], 
                    null, 
        ...
        @if($is_woocommerce)
            <div class="col-md-3" id="location_filter">
                <div class="form-group">
                    {!! Form::label('woocommerce_enabled',  __('lang_v1.woocommerce_enabled') . ':') !!}
                    {!! Form::select(
                        'woocommerce_enabled', 
                        ['woocommerce_sync' => __('lang_v1.woocommerce_sync'), 'woocommerce_no_sync' => __('lang_v1.woocommerce_no_sync')], 
                        null, 
                        ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')])
                    !!}
                </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function ( d ) {
                        ...
                        d.not_for_selling = $('#not_for_selling').val();
                        d.woocommerce_enabled = $('#woocommerce_enabled').val();
            ...
            $(document).on('change', '#not_for_selling, #woocommerce_enabled, #product_list_filter_type, #product_list_filter_category_id, #product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id, #active_state, #repair_model_id', 
                function() {

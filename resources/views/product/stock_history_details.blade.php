...
<div class="row">
	...
	<div class="col-md-4 col-xs-4">
		<strong>@lang('lang_v1.price')</strong>
		<table class="table table-condensed">
			<tr>
				<th>@lang('lang_v1.purchase_price')</th>
				<td>
					{{\App\Utils\Util::format_currency($stock_details['default_purchase_price'], $currency, true)}}
				</td>
			</tr>
			<tr>
				<th>@lang('lang_v1.purchase_price_inc_tax')</th>
				<td>
					{{\App\Utils\Util::format_currency($stock_details['dpp_inc_tax'], $currency, true)}}
				</td>
			</tr>
			<tr>
				<th>@lang('lang_v1.default_selling_price')</th>
				<td>
					{{\App\Utils\Util::format_currency($stock_details['default_sell_price'], $currency, true)}}
				</td>
			</tr>
			<tr>
				<th>@lang('lang_v1.default_selling_price_inc_tax')</th>
				<td>
					{{\App\Utils\Util::format_currency($stock_details['sell_price_inc_tax'], $currency, true)}}
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="col-md-12">
		...
		<table class="table table-slim" id="stock_history_table">
			...
			<tr>
				...
				<th>@lang('lang_v1.price_without_tax')</th>
			</tr>
			</thead>
			<tbody>
			@forelse($stock_history as $history)
				<tr>
					...
					<td>{{ \App\Utils\Util::format_currency($history['price'], $history['currency']) }}</td>
				</tr>
			@empty

  ...
  <div class="col-sm-12">
    ...
    <table class="table table-condensed">
      <tr>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $details['transaction_details']->total_sales ?? 0 }}</span></b>
        </td>
      </tr>
      
      <tr>
        <td>
          @lang('cash_register.total_credit_sales'):
        </td>
        <td>
          <b><span class="display_currency" data-currency_symbol="true">
            {{ ($details['transaction_payment_details']->total_credit ?? 0) + $details['credit_sale_details']['total_sales'] }}
          </span></b>
        </td>
      </tr>
      ...
      <tr>
        <td>
          @lang('cash_register.total_debit_sales'):
        </td>
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $details['transaction_payment_details']->total_debit ?? 0 }}</span></b>
        </td>
      </tr>
      ...
      <tr class="success">
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">
            {{ round($details['transaction_details']->total_sales - $details['transaction_details']->total_refund - $register_details->total_expense, 2) }}
          </span></b>
        </td>
      </tr>

  ...
  <div class="col-sm-12">
    ...
    <table class="table table-condensed">
      ...
      <tr class="danger">
        ...
        <td>
          @php
            $credit_refund = round($details['transaction_details']->total_refund - $register_details->total_refund, 2);
          @endphp

          <b><span class="display_currency" data-currency_symbol="true">{{ $details['transaction_details']->total_refund }}</span></b><br>
          <small>
          ...
          @endif
          @if($credit_refund > 0)
            Credit: <span class="display_currency" data-currency_symbol="true">{{ $credit_refund }}</span><br> 
          @endif
      ...
      <tr class="success">
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ round($register_details->cash_in_hand + $register_details->total_cash - $register_details->total_cash_refund, 2) }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ round($details['transaction_details']->total_sales - $details['transaction_details']->total_refund - $register_details->total_sale, 2) }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ round($details['transaction_details']->total_sales  - $details['transaction_details']->total_refund, 2)}}</span></b>
        </td>
      </tr>
      <tr class="danger">
        <th>

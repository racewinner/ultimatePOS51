<div class="box box-solid @if(!empty($expense->type) && $expense->type == 'expense_refund') hide @endif"
	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-4 col-sm-6">
				<br>
				<label>
					{!! Form::checkbox('is_recurring', 1, !empty($expense->is_recurring) == 1, ['class' => 'input-icheck', 'id' => 'is_recurring']) !!}

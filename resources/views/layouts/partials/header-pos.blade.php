  ...
  <div class="row">
    ...
    @endif
        ...
        @if(!empty($transaction->location_id)) {{$transaction->location->name}} @endif &nbsp; <span
          class="curr_datetime">{{ @format_datetime('now') }}</span> <i class="fa fa-keyboard hover-q text-muted"
    ...
    <div class="col-md-6">
      <a href="{{$go_back_url}}" title="{{ __('lang_v1.go_back') }}"
        class="btn btn-info  m-6 btn-xs m-5 pull-right">
      ...
      class="btn btn-primary  m-6 btn-xs m-5 pull-right" data-container=".view_modal"
    ...
    @endif
      ...
      class="btn btn-danger  m-6 btn-xs m-5 btn-modal pull-right" data-container=".close_register_modal"
    ...
    @endcan
      ...
      class="btn btn-success  m-6 btn-xs m-5 btn-modal pull-right" data-container=".register_details_modal"
    ...
    @endcan
      ...
      <button title="@lang('lang_v1.calculator')" id="btnCalculator" type="button"
        class="btn btn-success  pull-right m-5 btn-xs mt-10 popover-default" data-toggle="popover"
        data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true"
        data-placement="bottom">
        <strong><i class="fa fa-calculator fa-lg" aria-hidden="true"></i></strong>
      </button>

      <button type="button" class="btn btn-danger  m-6 btn-xs m-5 pull-right popover-default" id="return_sale"
        title="@lang('lang_v1.sell_return')" data-toggle="popover" data-trigger="click"
      ...
      <button type="button" title="{{ __('lang_v1.full_screen') }}"
        class="btn btn-primary  m-6 hidden-xs btn-xs m-5 pull-right" id="full_screen">
      ...
      <button type="button" id="view_suspended_sales" title="{{ __('lang_v1.view_suspended_sales') }}"
        class="btn bg-yellow  m-6 btn-xs m-5 btn-modal pull-right" data-container=".view_modal"
      ...
      class="btn btn-success  m-6 btn-xs m-5 btn-modal pull-right" data-toggle="modal"
    ...
    @endif
      ...
      class="btn btn-success  m-6 btn-xs m-5 pull-right">
    ...
    @endif
      ...
      class="btn bg-purple  m-6 btn-xs m-5 btn-modal pull-right" id="add_expense">

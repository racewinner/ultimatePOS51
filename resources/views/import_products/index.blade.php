        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>17</td>
                        <td>@lang('lang_v1.variation_sku') <small class="text-muted">(@lang('lang_v1.optional'))</small>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>{!! __('lang_v1.image_help_text', ['path' => 'public/uploads/' . config('constants.product_img_path')]) !!}
                            <br><br>

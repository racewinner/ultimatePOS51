...
@section('content')
  ...
  <section class="content">
    {!! Form::open([
    'url' => action([\App\Http\Controllers\BarcodeController::class, 'update'], [$barcode->id]),
    'method' => 'PUT',
    ...
    'placeholder' => __('barcode.setting_name')
      ...
      <div class="col-sm-12">
        ...
        {!! Form::textarea('description', $barcode->description, [
    'class' => 'form-control',
    ...
    'rows' => 3
      ...
      <div class="col-sm-12">
        ...
        <div class="checkbox">
          ...
          @lang('barcode.is_continuous')</label>
        </div>
        </div>
      </div>
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          {!! Form::number('top_margin', $barcode->top_margin, [
    'class' => 'form-control',
    ...
    'required'
      ...
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          {!! Form::number('left_margin', $barcode->left_margin, [
    'class' => 'form-control',
    ...
    'required'
      ...
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          {!! Form::number('width', $barcode->width, [
    'class' => 'form-control',
    ...
    'required'
      ...
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          {!! Form::number('height', $barcode->height, [
    'class' => 'form-control',
    ...
    'required'
      ...
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          {!! Form::number('paper_width', $barcode->paper_width, [
    'class' => 'form-control',
    ...
    'required'
      ...
      <div class="col-sm-6 paper_height_div @if($barcode->is_continuous) {{ 'hide' }} @endif">
        ...
        <div class="input-group">
          ...
          {!! Form::number('paper_height', $barcode->paper_height, [
    'class' => 'form-control',
    ...
    'required'
      ...
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          {!! Form::number('stickers_in_one_row', $barcode->stickers_in_one_row, [
    'class' => 'form-control',
    ...
    'required'
      ...
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          {!! Form::number('row_distance', $barcode->row_distance, [
    'class' => 'form-control',
    ...
    'required'
      ...
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          {!! Form::number('col_distance', $barcode->col_distance, [
    'class' => 'form-control',
    ...
    'required'
      ...
      <div class="col-sm-6 stickers_per_sheet_div @if($barcode->is_continuous) {{ 'hide' }} @endif">
        ...
        <div class="input-group">
          ...
          {!! Form::number('stickers_in_one_sheet', $barcode->stickers_in_one_sheet, [
    'class' => 'form-control',

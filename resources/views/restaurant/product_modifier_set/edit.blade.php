<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@lang('restaurant.products_for_modifier'): <span
          class="text-success">{{$modifer_set->name}}</span>
      </h4>
    </div>
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <td><button type="button" class="btn btn-danger btn-xs remove_modifier_product"><i

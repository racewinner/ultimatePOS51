	...
	<div class="col-md-3 col-xs-6 line_order_div">
		<div class="small-box bg-gray">
            ...
            @elseif($orders_for == 'waiter' && $order->res_order_status != 'served')
            	<a href="{{action([\App\Http\Controllers\Restaurant\OrderController::class, 'markLineOrderAsServed'], [$order->id])}}" class="btn  small-box-footer bg-yellow mark_line_order_as_served"><i class="fa fa-check-square-o"></i> @lang('restaurant.mark_as_served')</a>
            @else

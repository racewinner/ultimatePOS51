...
<div class="modal-body">
    ...
    <div class="row">
      ...
      <div class="@if(!empty($export_custom_fields)) col-sm-3 @else col-sm-4 @endif">
        ...
        @endif
        @if($sell->nation_exchg_rate > 0)
        <br><strong>@lang('lang_v1.currency_exchange_rate'):</strong>{{number_format((float)$sell->nation_exchg_rate, 2, '.', '')}}
        @endif
      ...
      <div class="col-md-6 col-sm-12 col-xs-12 @if($sell->type == 'sales_order') col-md-offset-6 @endif">
        <div class="table-responsive">
          <table class="table bg-gray">
            ...
            @if($business->enable_inline_tax && !empty($line_taxes))
            <tr>

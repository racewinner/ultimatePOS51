		...
		<div class="col-md-12">
			<div class="row">
				<div
					...
					<div class="w-100" style="background: white; border-radius:5px; padding: 10px 0px;">
						<h4 style="padding-left: 20px;">@lang('lang_v1.electronic_bill')</h4>
						<div class="electronic_bill_tab">
							<div class="checkbox">
								<label>
									<input class="input-icheck" name="pymo_sendinvoice" type="checkbox"
										v-model="active">

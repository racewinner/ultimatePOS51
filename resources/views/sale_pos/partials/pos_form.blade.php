		...
		<div class="form-group">
			<div class="input-group">
				...
				<span class="input-group-btn">
					<button type="button" class="btn btn-default bg-white  add_new_customer" data-name=""
			...
			<div class="input-group">
				...
				<span class="input-group-btn">
					...
					@if(isset($pos_settings['enable_weighing_scale']) && $pos_settings['enable_weighing_scale'] == 1)
						<button type="button" class="btn btn-default bg-white " id="weighing_scale_btn"
					...
					<button type="button" class="btn btn-default bg-white  pos_add_quick_product"

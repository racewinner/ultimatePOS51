<div class="row">
	<div class="col-md-12">
		<p>
		  ...
		  <input type="text" id="invoice_no" name="invoice_no" value="{{$transaction->invoice_no}}" />
		</p>
	</div>
	<div class="col-md-4">
		<div class="form-group" style="width: 100% !important">
			<div class="input-group">
				...
				<span class="input-group-btn">
					<button type="button" class="btn btn-default bg-white  add_new_customer" data-name=""  @if(!auth()->user()->can('customer.create')) disabled @endif><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
				</span>
			</div>
			...
			<div class="input-group">
				...
				<span class="input-group-btn">
					...
					@if(isset($pos_settings['enable_weighing_scale']) && $pos_settings['enable_weighing_scale'] == 1)
						<button type="button" class="btn btn-default bg-white " id="weighing_scale_btn" data-toggle="modal" data-target="#weighing_scale_modal" 

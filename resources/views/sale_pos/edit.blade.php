		...
		<div class="col-md-12">
			<div class="row">
				<div
					...
					<div class="box box-solid mb-12 @if(!isMobile()) mb-10 @endif">
						<div class="box-body pb-0">
							...
							{!! Form::hidden('invoice_no', $transaction->invoice_no, ['id' => 'invoice_no']) !!}
							{!! Form::hidden('nation_exchg_rate', $transaction->nation_exchg_rate, ['id' => 'nation_exchg_rate']) !!}
							<!-- sub_type -->

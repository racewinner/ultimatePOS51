...
<section class="content">
  ...
  {!! Form::open(['url' =>  action([\App\Http\Controllers\PurchaseOrderController::class, 'update'] , [$purchase->id] ), 'onsubmit' => 'return onAddPurchaseFormSubmit();', 'method' => 'PUT', 'id' => 'add_purchase_form', 'files' => true ]) !!}
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            {!!Form::text('shipping_charges',number_format($purchase->shipping_charges, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator),['class'=>'form-control input_number','placeholder'=> __('sale.shipping_charges')]);!!}
            </div>
          </div>
        </div>

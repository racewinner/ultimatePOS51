...
<section class="content">
	...
	{!! Form::open(['url' => action([\App\Http\Controllers\PurchaseOrderController::class, 'store']), 'onsubmit' => 'return onAddPurchaseFormSubmit();', 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}

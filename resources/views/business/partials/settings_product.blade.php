    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('show_combo_variations', 1, $business->show_combo_variations, [ 'class' => 'input-icheck']) !!} {{ __( 'lang_v1.show_combo_products' ) }}
                  </label>
                  @show_tooltip(__('lang_v1.show_combo_products'))
                </div>
            </div>
        </div>
    </div>

<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                {!! Form::label('second_currency_id', __('lang_v1.second_currency')) !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fas fa-money-bill-alt"></i>
                    </span>
                    {!! Form::select('second_currency_id', $currencies, $business->second_currency_id, ['class' => 'form-control select2','placeholder' => __('lang_v1.second_currency')]) !!}
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                {!! Form::label('nation_currency_id', __('lang_v1.nation_currency') . ':*') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fas fa-money-bill-alt"></i>
                    </span>
                    {!! Form::select('nation_currency_id', $currencies, $business->nation_currency_id, ['class' => 'form-control select2','placeholder' => __('lang_v1.nation_currency'), 'required']) !!}
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                {!! Form::label('nation_exchg_rate', __('lang_v1.exchg_rate')) !!}
                <div class="d-flex align-items-center w-100">
                    <div class="input-group">
                        ...
                        {!! Form::number(
                            'nation_exchg_rate', 
                            $business->nation_exchg_rate, 
                            [
                                'class' => 'form-control',
                                'placeholder' => __('lang_v1.exchg_rate')
                            ])
                        !!}
                    </div>
                    <button type="button" class="btn btn-primary ms-1" id="btn_get_from_bcu">Get From BCU</button>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                {!! Form::label('enable_bcu', __('lang_v1.auto_update_from_bcu')) !!}
                <div class="input-group">
                        <label>
                            {!! Form::checkbox('enable_bcu', 1, $business->enable_bcu, 
                            [ 'class' => 'input-icheck m-0']) !!} {{ __( 'lang_v1.enable_bcu' ) }}
                        </label>
                </div>
            </div>
        </div>

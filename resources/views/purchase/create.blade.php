...
<section class="content">
	...
	{!! Form::open(['url' => action([\App\Http\Controllers\PurchaseController::class, 'store']), 'onsubmit' => 'return onAddPurchaseFormSubmit();', 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('purchase.add_payment')])
		<div class="box-body payment_row">
			...
			<div class="row">
				<div class="col-sm-12">
					<button id="submit_purchase_form" class="btn btn-primary pull-right ">@lang('messages.save')</button>
				</div>
			</div>
		</div>
	@endcomponent

@foreach( $variations as $variation)
    <tr @if(!empty($purchase_order_line)) data-purchase_order_id="{{$purchase_order_line->transaction_id}}" @endif @if(!empty($purchase_requisition_line)) data-purchase_requisition_id="{{$purchase_requisition_line->transaction_id}}" @endif>
        ...
        <td>
            ...
            <input type="hidden" class="prod-currency-id" name="purchases[{{$row_count}}][currency_id]" value="{{$variation->currency_id}}">
        ...
        <td>
            ...
            number_format($pp_without_discount, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost_without_discount input_number', 'required']) !!}
        ...
        <td>
            {!! Form::text('purchases[' . $row_count . '][discount_percent]', number_format($discount_percent, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm inline_discounts input_number', 'required']) !!}
        ...
        <td>
            ...
            number_format($purchase_price, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost input_number', 'required']) !!}
        </td>
        <td class="{{$hide_tax}}">
        ...
        <td class="{{$hide_tax}}">
            @php
                $dpp_inc_tax = number_format($variation->dpp_inc_tax, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator);
                if($hide_tax == 'hide'){
                    $dpp_inc_tax = number_format($variation->default_purchase_price, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator);
                }

                $dpp_inc_tax = !empty($purchase_order_line) ? number_format($purchase_order_line->purchase_price_inc_tax, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator) : $dpp_inc_tax;
        ...
        <td class="@if(!session('business.enable_editing_product_from_purchase') || !empty($is_purchase_order)) hide @endif">
            {!! Form::text('purchases[' . $row_count . '][profit_percent]', number_format($variation->profit_percent, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm input_number profit_percent', 'required']) !!}
        </td>
        @if(empty($is_purchase_order))
        <td>
            @if(session('business.enable_editing_product_from_purchase'))
                {!! Form::text('purchases[' . $row_count . '][default_sell_price]', number_format($variation->sell_price_inc_tax, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm input_number default_sell_price', 'required']) !!}
            @else
                {{ number_format($variation->sell_price_inc_tax, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator)}}
            @endif
        </td>

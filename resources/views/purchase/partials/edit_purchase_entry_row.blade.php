...
<div class="table-responsive">
    ...
    @foreach($purchase->purchase_lines as $purchase_line)
        <tr @if(!empty($purchase_line->purchase_order_line) && !empty($common_settings['enable_purchase_order'])) data-purchase_order_id="{{$purchase_line->purchase_order_line->transaction_id}}" @endif  @if(!empty($purchase_line->purchase_requisition_line) && !empty($common_settings['enable_purchase_requisition'])) data-purchase_requisition_id="{{$purchase_line->purchase_requisition_line->transaction_id}}" @endif>
            ...
            <td>
                {!! Form::text('purchases[' . $loop->index . '][pp_without_discount]', number_format($purchase_line->pp_without_discount, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost_without_discount input_number', 'required']) !!}
            </td>
            <td>
                {!! Form::text('purchases[' . $loop->index . '][discount_percent]', number_format($purchase_line->discount_percent, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm inline_discounts input_number', 'required']) !!} <b>%</b>
            </td>
            <td>
                {!! Form::text('purchases[' . $loop->index . '][purchase_price]', 
                number_format($purchase_line->purchase_price, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost input_number', 'required']) !!}
            </td>
            <td class="{{$hide_tax}}">
                <span class="row_subtotal_before_tax">
                    {{number_format($purchase_line->quantity * $purchase_line->purchase_price, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator)}}
                </span>
                <input type="hidden" class="row_subtotal_before_tax_hidden" value="{{number_format($purchase_line->quantity * $purchase_line->purchase_price, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator)}}">
            </td>
            ...
            <td class="{{$hide_tax}}">
                <div class="input-group">
                    ...
                    <span class="input-group-addon purchase_product_unit_tax_text">
                        {{number_format($purchase_line->item_tax, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator)}}
                    </span>
                    {!! Form::hidden('purchases[' . $loop->index . '][item_tax]', number_format($purchase_line->item_tax, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'purchase_product_unit_tax']) !!}
                </div>
            </td>
            <td class="{{$hide_tax}}">
                {!! Form::text('purchases[' . $loop->index . '][purchase_price_inc_tax]', number_format($purchase_line->purchase_price_inc_tax, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost_after_tax input_number', 'required']) !!}
            </td>
            <td>
                <span class="row_subtotal_after_tax">
                {{number_format($purchase_line->purchase_price_inc_tax * $purchase_line->quantity, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator)}}
                </span>
                <input type="hidden" class="row_subtotal_after_tax_hidden" value="{{number_format($purchase_line->purchase_price_inc_tax * $purchase_line->quantity, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator)}}">
            </td>
            ...
            <td class="@if(!session('business.enable_editing_product_from_purchase') || !empty($is_purchase_order)) hide @endif">
                ...
                number_format($profit_percent, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), 
                ['class' => 'form-control input-sm input_number profit_percent2', 'required']) !!}
            </td>
            @if(empty($is_purchase_order))
            <td>
                @if(session('business.enable_editing_product_from_purchase'))
                    {!! Form::text('purchases[' . $loop->index . '][default_sell_price]', number_format($sp, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator), ['class' => 'form-control input-sm input_number default_sell_price', 'required']) !!}
                @else
                    {{number_format($sp, $currency_precision, $purchase_currency->decimal_separator, $purchase_currency->thousand_separator)}}
                @endif

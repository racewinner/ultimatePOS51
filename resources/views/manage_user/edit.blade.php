      ...
      <div class="col-md-4">
        <div class="form-group">
          <div class="checkbox">
            <br />
            <label>
              {!! Form::checkbox('selected_contacts',1,$user->selected_contacts,['class' => 'input-icheck', 'id' => 'selected_contacts']) !!}
      ...
      <div class="col-sm-4">
        <div class="form-group">
          <div class="checkbox">
            <br>
            <label>
              {!! Form::checkbox('enable_pin',1,!empty($user['enable_pin']),['class' => 'input-icheck']) !!} 
	      {{ __('lang_v1.enable_pin') }}
            </label>
          </div>
        </div>
      </div>

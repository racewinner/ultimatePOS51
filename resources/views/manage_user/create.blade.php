...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      @component('components.widget', ['title' => 'PIN'])
      <div class="col-sm-4">
        <div class="form-group">
          {!! Form::label('pin', "PIN") !!}
          {!! Form::text('pin', $user['pin'], ['class' => 'form-control']) !!}
        </div>
      </div>
    ...
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <br>
          <label>
              {!! Form::checkbox('enable_pin', 1, !empty($user['enable_pin']) , 
              [ 'class' => 'input-icheck']) !!} {{ __( 'lang_v1.enable_pin' ) }}
          </label>
        </div>            
      </div>
    </div>
  ...
  @section('javascript')
    ...
    $(document).ready(function () {
      ...
      var selectedData = e.params.data; // Get the selected data
      console.log(selectedData);
      // Perform any additional actions with the selected data
    });
    ...
    $('form#user_add_form').validate({
      ...
      pin: {
      remote: {
      url: "/business/register/check-pin",
      type: "post",
      data: {
        pin: function () {
        return $("#pin").val();
      ...
      pin: {
      remote: 'The same pin already exists'
      }
    }
        });

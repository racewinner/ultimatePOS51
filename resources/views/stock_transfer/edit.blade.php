							...
							<select name='currency_id' class='form-control select2' disabled>
								@foreach ($currencies as $currency)
									<option value={{ $currency->id }} 
										{{ $currency->id == $sell_transfer->currency_id ? "selected" : "" }} 
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::number('exchange_rate', $sell_transfer->exchage_rate, ['class' => 'form-control', 'placeholder' => __('lang_v1.currency_exchange_rate'), 'readonly' => true]) !!}
						</div>
					</div>
				</div>
		...
		<div class="box-body">
			...
			<div class="row">
				<div class="col-md-12 text-right">
					...
					<b>@lang('stock_adjustment.total_amount'):</b> <span
						id="final_total_text">{{@num_format($final_total)}}</span>
				</div>
				<br>
				<br>

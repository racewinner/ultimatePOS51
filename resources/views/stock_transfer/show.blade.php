				...
				<div class="row invoice-info">
				  <div class="col-sm-4 invoice-col">
				    ...
				    <address>
					  ...
					  <br>@lang('lang_v1.currency_exchange_rate'): {{number_format((float)$sell_transfer->nation_exchg_rate, 2, '.', '')}}
					  @endif
				    </address>
				  </div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		const transfer_currency = @json($sell_transfer->currency);
		__p_currency_symbol = transfer_currency.symbol;
		__p_currency_thousand_separator = transfer_currency.thousand_separator;
		__p_currency_decimal_separator = transfer_currency.decimal_separator;

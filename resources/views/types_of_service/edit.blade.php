    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="form-group col-md-12">
          ...
          <td>{{$value}}</td>
          <td>
            {!! Form::select('location_price_group[' . $key . ']', $price_groups, !empty($type_of_service->location_price_group[$key]) ? $type_of_service->location_price_group[$key] : null, ['class' => 'form-control input-sm select2', 'style' => 'width: 100%;']) !!}
          </td>
          </tr>
        @endforeach
            </thead>
        ...
        <div class="form-group col-md-12">
          <div class="checkbox">
            <label>
              {!! Form::checkbox('enable_custom_fields', 1, !empty($type_of_service->enable_custom_fields)) !!}
              @lang('lang_v1.enable_custom_fields')

		...
		<div class="modal-body">
			...
			<div class="row invoice-info">
				<div class="col-sm-4 invoice-col">
					...
					<br>@lang('lang_v1.currency_exchange_rate'): {{number_format((float)$stock_adjustment->nation_exchg_rate, 2, '.', '')}}
					@endif
			      </address>
			    </div>
...
<script type="text/javascript">
	...
	debugger;
    const stock_currency = @json($stock_adjustment->currency);
    __p_currency_symbol = stock_currency.symbol;
    __p_currency_thousand_separator = stock_currency.thousand_separator;
    __p_currency_decimal_separator = stock_currency.decimal_separator;

<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
          ...
          <div class="col-sm-6 col-xs-6">
            ...
            <strong>@lang('lang_v1.return_note'):</strong> {{ $sell->return_parent?->additional_notes }}
          </div>
        </div>
        <br>
        <div class="row">
    ...
    <div class="modal-footer">
        <a href="#" class="btn btn-primary return-invoice-print" data-id="{{ $sell->return_parent->id }}"><i class="fa fa-print" aria-hidden="true"></i> @lang("messages.print")</a>

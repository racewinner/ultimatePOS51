    ...
    <div class="modal-body">
      ...
      <div class="row">
          ...
          <div class="col-xs-12 mt-4">
            ...
            @endif
            @if(!empty($single_payment_line->document2_path))
              <a href="{{$single_payment_line->document2_path}}" class="btn btn-success btn-xs no-print" download="{{$single_payment_line->document2_name}}"><i class="fa fa-download" data-toggle="tooltip" title="{{__('purchase.download_document')}}"></i> {{__('purchase.download_document')}}</a>
            @endif
          </div>
      </div>
    </div>

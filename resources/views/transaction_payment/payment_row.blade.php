  ...
  @endif
      ...
      @endif
        ...
        <div class="col-md-4">
          <div class="well">
            ...
            <span>{{ \App\Utils\Util::format_currency($transaction->final_total, $transaction->currency) }}</span><br>
    ...
    @endif
        ...
        <div class="col-md-4">
          <div class="form-group">
            {!! Form::label('document', __('purchase.attach_document') . ':') !!}
            {!! Form::file('document2', ['accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]) !!}
            <p class="help-block">
              @includeIf('components.document_help_text')</p>
          </div>
        </div>

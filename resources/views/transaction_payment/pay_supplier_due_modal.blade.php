    ...
    @endif
      <div class="row payment_row">
        ...
        <div class="col-md-6">
          ...
          <option value={{ $currency->id }} data-thousand-separator={{ empty($currency->thousand_separator) ? "NA" : $currency->thousand_separator }} data-decimal-separator={{ empty($currency->decimal_separator) ? "NA" : $currency->decimal_separator}} data-symbol={{ $currency->symbol }}>
            {{ $currency->name }}
          </option>
        @endforeach
              </select>

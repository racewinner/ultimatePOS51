<div class="modal-dialog modal-lg" role="document">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-15">
                    <label class="radio-inline">
                        <input type="radio" name="contact_type_radio" id="inlineRadio1" value="individual" required
                            <?=$contact->contact_type_radio == 'individual' ? 'checked' : '' ?>>
                        @lang('lang_v1.individual')
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="contact_type_radio" id="inlineRadio2" value="business" required
                            <?=$contact->contact_type_radio == 'business' ? 'checked' : '' ?>>
    ...
    ['class' => 'form-control', 'placeholder' => __('business.business_name')]
                ...
                <div class="col-md-4 business">
                    <div class="form-group">
                        {!! Form::label('fantasy_name', __('lang_v1.fantasy_name') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-briefcase"></i>
                            </span>
                            {!! Form::text('fantasy_name', $contact->fantasy_name, ['class' => 'form-control', 'placeholder' => __('lang_v1.fantasy_name')]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label class="business">{!! Form::label('rut', __('lang_v1.rut_id') . ':') !!}</label> /
                        <label class="individual">{!! Form::label('rut', __('lang_v1.identy_id') . ':') !!}</label>
                        <div class="input-group">
                            {!! Form::text('rut', !empty($contact->rut) ? $contact->rut : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.rut_id'), 'required']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div id="more_div" class="hide">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_field2', $contact->custom_field2, ['class' => 'form-control','placeholder' => $contact_custom_field2]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('custom_field3', $contact_custom_field3 . ':') !!}
                            {!! Form::text('custom_field3', $contact->custom_field3, ['class' => 'form-control','placeholder' => $contact_custom_field3]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('custom_field4', $contact_custom_field4 . ':') !!}
                            {!! Form::text('custom_field4', $contact->custom_field4, ['class' => 'form-control','placeholder' => $contact_custom_field4]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('custom_field5', $contact_custom_field5 . ':') !!}
                            {!! Form::text('custom_field5', $contact->custom_field5, ['class' => 'form-control','placeholder' => $contact_custom_field5]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('custom_field6', $contact_custom_field6 . ':') !!}
                            {!! Form::text('custom_field6', $contact->custom_field6, ['class' => 'form-control','placeholder' => $contact_custom_field6]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('custom_field7', $contact_custom_field7 . ':') !!}
                            {!! Form::text('custom_field7', $contact->custom_field7, ['class' => 'form-control','placeholder' => $contact_custom_field7]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('custom_field8', $contact_custom_field8 . ':') !!}
                            {!! Form::text('custom_field8', $contact->custom_field8, ['class' => 'form-control','placeholder' => $contact_custom_field8]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('custom_field9', $contact_custom_field9 . ':') !!}
                            {!! Form::text('custom_field9', $contact->custom_field9, ['class' => 'form-control','placeholder' => $contact_custom_field9]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('custom_field10', $contact_custom_field10 . ':') !!}
                            {!! Form::text('custom_field10', $contact->custom_field10, ['class' => 'form-control','placeholder' => $contact_custom_field10]) !!}
                        </div>
                    </div>
                    <div class="clearfix"></div>

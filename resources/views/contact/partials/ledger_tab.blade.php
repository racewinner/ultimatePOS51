...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-2 text-right">
            ...
            <button
                data-href="{{action([\App\Http\Controllers\ContactController::class, 'downloadExcel'])}}?contact_id={{$contact->id}}&action=excel"
                class="btn btn-default btn-xs" id="print_ledger_excel"><i class="fas fa-file-excel"></i></button>
        </div>
    </div>
